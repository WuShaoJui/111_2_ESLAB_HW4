...
class Heartrate_Button : ble::Gap::EventHandler {
public:
    Heartrate_Button(BLE &ble, events::EventQueue &event_queue) :
        _ble(ble),
    ...
    void start()
    {
        _ble.init(this, &Heartrate_Button::on_init_complete);
...
private:
    ...
    void on_init_complete(BLE::InitializationCompleteCallbackContext *params)
    {
        ...
        _button.fall(Callback<void()>(this, &Heartrate_Button::button_pressed));
        _button.rise(Callback<void()>(this, &Heartrate_Button::button_released));
        ...
        _event_queue.call_every(500ms, this, &Heartrate_Button::blink);
    ...
    void start_advertising()
    {
        ...
        _adv_data_builder.setLocalServiceList({&_button_uuid, 1});
...
int main()
{
    ...
    Heartrate_Button SVC(ble, event_queue);
    SVC.start();
